...
class AuthService extends ChangeNotifier {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      if (kDebugMode) {
        print('❌ Greška pri inicijalizaciji autentifikacije: $e');
      }
      await clearAuth();
    }
  ...
  Future<bool> login(AuthResponse authResponse) async {
    try {
      ...
      if (kDebugMode) {
        print('❌ Greška pri čuvanju podataka za autentifikaciju: $e');
      }
      return false;
    }
  }
  ...
  Future<bool> refreshToken() async {
    ...
    try {
      // Token refresh logic will be implemented by the API client
      if (kDebugMode) {
