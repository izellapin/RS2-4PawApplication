...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _saveChanges() async {
    ...
    if (updateData.isEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Nema promena za čuvanje')),
      );
      return;
    }
  ...
  void _showChangePasswordDialog() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('Promeni Šifru'),
        content: Form(
          key: formKey,
          child: Column(
              ...
              onPressed: () async {
                if (formKey.currentState!.validate()) {
                  try {
                    ...
                    await serviceLocator.apiClient.updateCurrentUser({
            ...
            children: [
              ...
              if (!_isEditing) ...[
                ...
                ElevatedButton.icon(
                  ...
                  label: const Text('Promeni šifru'),
